...
public class MineNickName extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		submit.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if (email.equals("")) {
					Toast.makeText(MineNickName.this, "输入不能为空", Toast.LENGTH_SHORT)
							.show();
				} else {
					Intent intent = new Intent(MineNickName.this,
							MineInformation.class);
					intent.putExtra("nickname", email);
					MineNickName.this.setResult(50,intent);
